...
class KafkaApp:
    def __init__(
        ...
        self.active_producer_key: Optional[str] = None
    ...
    def send(
        ...
        if self.active_producer_key is not None:
            worker = self.producers[self.active_producer_key]
        ...
        if topic.return_topic is not None:
            result = self._return_consume(topic.return_topic, req_id)
    ...
    def _commit(self):
        if self.active_producer_key is not None:
            ...
            self.producers[self.active_producer_key].commit_transaction()
            self.active_producer_key = None
    ...
    def consume(
        ...
        try:
            ...
            while self.consumer_active:
                ...
                self.active_producer_key = producer_key
